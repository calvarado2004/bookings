...
func TestForm_Required(t *testing.T) {
	...
	form.Required("a", "b", "c")
	if form.Valid() {
		t.Error("form shows valid when there are required fields missing")
	}
...
func TestForm_IsEmail(t *testing.T) {
	...
	postedValues.Add("email", "elliot.alderson@fsociety.com")
	...
	if !form.Valid() {
		t.Error("form shows invalid email when we passed a valid one")
	}
	...
	if form.Valid() {
		t.Error("form shows valid email when we passed an invalid one")
	}
