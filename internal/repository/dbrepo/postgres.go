...
//Authenticate authenticates a user by comparing the hashed password provided against the saved one on the DB
...
//AllNewReservations filters for all the new reservations
func (m *postgresDBRepo) AllNewReservations() ([]models.Reservation, error) {
	...
	var newreservations []models.Reservation
	...
	for rows.Next() {
		...
		newreservations = append(newreservations, i)
...
//UpdateReservations update a reservation
...
//DeleteReservations delete a reservation by id
func (m *postgresDBRepo) DeleteReservations(id int) error {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
...
//GetRestrictionsForRoomByDate get all the restrictions that applies for a certain room by date range
...
//DeleteBlockByID delete a block of room restrictions using its ID
