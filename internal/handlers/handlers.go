...
//ShowAdminlogin
func (m *Repository) ShowAdminlogin(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "login-admin.page.html", &models.TemplateData{
		Form: forms.New(nil),
	})
}

//PostShowAdminlogin handles logging the user in
func (m *Repository) PostShowAdminlogin(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "user_id", id)
	m.App.Session.Put(r.Context(), "flash", "logged in successfully")
	http.Redirect(w, r, "/bookings-admin/reservations", http.StatusSeeOther)

}

//AdminLogout logs a user out
