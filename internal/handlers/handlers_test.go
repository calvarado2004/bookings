...
func TestRepository_PostReservation(t *testing.T) {
	...
	req, _ := http.NewRequest("POST", "/bookings/reservation", strings.NewReader(postedData.Encode()))
	ctx := getCtx(req)
	req = req.WithContext(ctx)
...
func TestRepository_PostAvailability(t *testing.T) {
	...
	*****************************************/
	...
	// create our request
	req, _ := http.NewRequest("POST", "/bookings/availability", strings.NewReader(postedData.Encode()))
	...
	*****************************************/
	...
	req, _ = http.NewRequest("POST", "/bookings/availability", nil)
...
func TestRepository_AvailabilityJSON(t *testing.T) {
	...
	*****************************************/
	...
	// create our request
	req, _ := http.NewRequest("POST", "/bookings/availability-json", strings.NewReader(postedData.Encode()))
	...
	*****************************************/
	// create our request
	req, _ = http.NewRequest("POST", "/bookings/availability-json", nil)
...
func TestRepository_ReservationSummary(t *testing.T) {
	...
	*****************************************/
	...
	req, _ := http.NewRequest("GET", "/bookings/reservation-summary", nil)
	ctx := getCtx(req)
	req = req.WithContext(ctx)
...
func TestRepository_ChooseRoom(t *testing.T) {
	...
	*****************************************/
	...
	req, _ := http.NewRequest("GET", "/bookings/choose-room/1", nil)
	ctx := getCtx(req)
	req = req.WithContext(ctx)
	// set the RequestURI on the request so that we can grab the ID
	// from the URL
	req.RequestURI = "/bookings/choose-room/1"
	...
	//*****************************************/
	req, _ = http.NewRequest("GET", "/bookings/choose-room/fish", nil)
	ctx = getCtx(req)
	req = req.WithContext(ctx)
	req.RequestURI = "/bookings/choose-room/fish"
...
func TestRepository_BookRoom(t *testing.T) {
	...
	*****************************************/
	...
	req, _ := http.NewRequest("GET", "/bookings/book-room?s=2050-01-01&e=2050-01-02&id=1", nil)
	ctx := getCtx(req)
	req = req.WithContext(ctx)
	...
	*****************************************/
	req, _ = http.NewRequest("GET", "/bookings/book-room?s=2040-01-01&e=2040-01-02&id=4", nil)
	ctx = getCtx(req)
	req = req.WithContext(ctx)
